...
export const ShoppingCartProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (!searchTitle && searchByCategory) setFilteredItems(filterBy('BY_CATEGORY', items, searchTitle, searchByCategory))
    if (!searchTitle && !searchByCategory) setFilteredItems(filterBy(null, items, searchTitle, searchByCategory))
